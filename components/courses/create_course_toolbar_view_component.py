...
class CreateCourseToolbarViewComponent(BaseComponent):
    def __init__(self, page: Page) -> None:
        ...
        self.create_course_title = Text(page, 'create-course-toolbar-create-course-button', 'Title')
        self.create_course_button = Button(page, 'create-course-toolbar-title-text', 'Create_Button')
